...
ALL_CONSTANTS: dict = {
    "password_min_length": PASSWORD_MIN_LENGHT,
    "password_max_length_slider": PASSWORD_MAX_LENGHT_SLIDER,
    "password_max_length_spinbox": PASSWORD_MAX_LENGHT_SPINBOX,
    "password_start_value": PASSWORD_START_VALUE,

    "entropy_threshold": ENTROPY_THRESHOLD,

    "inactivity_timer_length": INACTIVITY_TIMER_LENGHT,
